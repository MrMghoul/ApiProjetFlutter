...
def predict():
    ...
    print(f"Received file: {file.filename}, file size: {len(file.read())} bytes")  # Vérifier la taille du fichier

    file.seek(0)  # Revenir au début du fichier après avoir lu sa taille
    try:
